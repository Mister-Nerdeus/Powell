    ...
    <section className="powell-section-band py-14 sm:py-16">
      <PageContainer>
        <div className="mb-6 max-w-3xl">
          ...
          <h2 className="mt-3 text-3xl font-bold tracking-tight text-white sm:text-4xl">Friendly people, useful materials, and a business that feels established</h2>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {reviewThemes.map((item) => (
            <div key={item.title} className="powell-panel rounded-3xl p-6 text-sm leading-7 text-stone-200">
