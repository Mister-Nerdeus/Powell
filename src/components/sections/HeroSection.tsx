        ...
        <div className="grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
          <div>
            <p className="inline-flex rounded-full border border-amber-400/20 bg-amber-400/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.24em] text-amber-200 sm:text-sm">
              Howard City • Excavation • Materials • Direct phone contact
            </p>
            ...
            <div className="mt-6 grid gap-3 text-sm text-stone-200 sm:grid-cols-2">
              <div className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3">Call about excavation, septic support, drainfields, grading, driveways, and ponds.</div>
              <div className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3">Call about road gravel, topsoil, stone, millings, storage, and general project questions.</div>
            </div>
          ...
          <ResponsiveImage imageKey="hero-current-1" fallbackLabel="Powell image coming soon." className="min-h-[340px] shadow-soft" />
        </div>
      </PageContainer>
    </section>
  );
